...
export class CDNServices extends EditableConfigList<
  CDNServicesData,
  CDNServiceData
> {
...
function mapStateToProps(state, ownProps) {
  const data = Object.assign(
    {},
    (state.editor.cdnServices && state.editor.cdnServices.data) || {}
  );
  ...
  return {
    data: data,
    responseBody:
      state.editor.cdnServices && state.editor.cdnServices.successMessage,
    fetchError: state.editor.cdnServices.fetchError,
    formError: state.editor.cdnServices.formError,
    isFetching:
      state.editor.cdnServices.isFetching || state.editor.cdnServices.isEditing,
  };
}
...
function mapDispatchToProps(dispatch, ownProps) {
  ...
  return {
    ...
    deleteItem: (identifier: string | number) =>
      dispatch(actions.deleteCDNService(identifier)),
  };
}

const ConnectedCDNServices = connect<
  EditableConfigListStateProps<CDNServicesData>,
  EditableConfigListDispatchProps<CDNServicesData>,
  EditableConfigListOwnProps
>(
  mapStateToProps,
  mapDispatchToProps
