...
const LibraryStats = (props: LibraryStatsProps) => {
  ...
  return (
    <div className="library-stats">
      ...
      <ul className="stats">
        <li className="stat-group">{patronsGroup(patrons)}</li>
        <li className="stat-group">{circulationsGroup(patrons)}</li>
        <li className="stat-group">{inventoryGroup(inventory)}</li>
        <li className="stat-group stat-group-wide">
          {collectionsGroup(chartItems, CustomTooltip)}
        </li>
      </ul>
    </div>
  );
...
const patronsGroup = (patrons: PatronStatistics) => {
  return (
    <>
      <h3>
...
const circulationsGroup = (patrons: PatronStatistics) => {
  return (
    <>
      <h3>
...
const inventoryGroup = (inventory: InventoryStatistics) => {
  return (
    <>
      <h3>
...
const collectionsGroup = (chartItems, customTooltip) => {
