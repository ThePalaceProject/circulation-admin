...
export class LoggingServices extends EditableConfigList<
  LoggingServicesData,
  LoggingServiceData
> {
...
function mapStateToProps(state, ownProps) {
  ...
  return {
    ...
    responseBody:
      state.editor.loggingServices &&
      state.editor.loggingServices.successMessage,
    fetchError: state.editor.loggingServices.fetchError,
    formError: state.editor.loggingServices.formError,
    isFetching:
      state.editor.loggingServices.isFetching ||
      state.editor.loggingServices.isEditing,
  };
}
...
function mapDispatchToProps(dispatch, ownProps) {
  ...
  return {
    ...
    deleteItem: (identifier: string | number) =>
      dispatch(actions.deleteLoggingService(identifier)),
  };
}

const ConnectedLoggingSettings = connect<
  EditableConfigListStateProps<LoggingServicesData>,
  EditableConfigListDispatchProps<LoggingServicesData>,
  EditableConfigListOwnProps
>(
  mapStateToProps,
  mapDispatchToProps
