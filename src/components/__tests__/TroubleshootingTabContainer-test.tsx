...
describe("TroubleshootingTabContainer", () => {
  ...
  beforeEach(() => {
    goToTab = stub();
    wrapper = shallow(<TroubleshootingTabContainer goToTab={goToTab} tab="diagnostics" />);
  });
  ...
  it("calls goToTab", () => {
    ...
    let selfTestsTab = tabs.at(1);
    selfTestsTab.simulate("click", { currentTarget : { dataset: { tabkey: "self-tests" } } });
