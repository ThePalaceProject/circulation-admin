...
// react-beautiful-dnd does not work in jsdom, so - as the legacy enzyme test
// did - we do not exercise real pointer/keyboard drag gestures. Instead we mock
// the library:
...
//     the legacy test asserted on that prop stays observable.
