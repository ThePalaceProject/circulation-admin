...
// ── Migrated from src/components/__tests__/DiscoveryServices-test.tsx ─────────
//
...
// which only run when the CONNECTED default export mounts) and the
// getChildContext().registerLibrary closure (which only runs when a library is
// registered from the edit form).

describe("DiscoveryServices - connected wiring and registration (migrated)", () => {
  const allLibraries = [
