...
describe("ServiceEditForm", () => {
  ...
  // JSX works without generic inference (mirrors the legacy test's alias).
  ...
  describe("rendering", () => {
    ...
    it("renders neighborhood analytics form for a relevant patron auth protocol", () => {
      ...
      rerenderForm(rerender, {
        ...
        // The pared-down protocol setting omits `label`; cast as the legacy
        // (untyped setProps) test did.
        data: {
          ...servicesData,
  ...
  describe("behavior", () => {
    ...
    it("doesn't clear the form if there's an error message", async () => {
      ...
      // is passed via an untyped props object (as the legacy test did).
