...
describe("CustomLists", () => {
  ...
  // (src/components/__tests__/CustomLists-test.tsx). These render the
  // unconnected component with explicit props (mirroring the legacy test),
  // drive the real sidebar, and stub the heavy CustomListEditor child so the
  // component's own render/lifecycle/methods are exercised observably. Nested
  // inside the top-level describe so the MSW server and scrollTo stub apply.
  describe("legacy behaviors", () => {
