...
describe("EditorField", () => {
  ...
  it("renders the three inline-style buttons and toggles the matching style on mouse-down", () => {
    // The legacy test stubbed the instance's `changeStyle` and asserted the style
    // argument. There is no DOM-observable effect of toggling an inline style over a
